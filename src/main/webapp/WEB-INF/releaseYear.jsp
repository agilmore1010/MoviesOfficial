...
<head>
    <title>Movies released in ${releaseYear}</title>
...
<body>
    <div class="container">
        <h2>Movies released in ${releaseYear}</h2>
        <ul class="releaseyear-list">
    ...
    <div class="count">
        <p>Number of movies released in ${releaseYear}: ${movieCount}</p>
