...
<head>
    <title>Movies that are ${timeLength} long</title>
...
<body>
    <div class="container">
        <h2>Movies that are ${timeLength} long</h2>
        <ul class="timelength-list">
    ...
    <div class="count">
        <p>Number of movies that are ${timeLength} long: ${movieCount}</p>
